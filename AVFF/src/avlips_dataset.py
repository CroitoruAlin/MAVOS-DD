...
class AVLips(Dataset):
        ...
        def gen_path():
            for dir_videos in os.listdir(input_path):
                ...
                for video_path in video_paths:
                    out_dir = {"video_path": video_path, 'label': 'fake' if 'fake' in dir_videos else 'real'}
                    yield out_dir
    ...
    def _get_frames(self, video_name):
        try:
            ...
            # PIL.Image.fromarray(frames[0].astype(np.uint8)).save("frame_av.png")
            # exit()
