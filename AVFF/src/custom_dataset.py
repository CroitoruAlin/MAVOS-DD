...
class CustomDDV(Dataset):
    def __init__(self, audio_conf, stage, num_frames=16):
        input_path = "/home/eivor/biodeep/Detection/OpenAVFF/img"
        ...
        self.dataset = pd.DataFrame({
            "video_path": [
                "/home/eivor/biodeep/Detection/OpenAVFF/img/anaconda.mp4",
                "/home/eivor/biodeep/Detection/OpenAVFF/img/newborn.mp4",
            ],
            "label": ["fake", "fake"],
            "split": ["test", "test"],
            "username": ["Vlad Hondru", "Vlad Hondru"],
            "text": ["None", "None"],
